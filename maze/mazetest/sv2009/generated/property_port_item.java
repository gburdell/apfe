...
public  class property_port_item extends Acceptor implements NonTerminal, ITokenCodes {

    public property_port_item() {
    }
...
new Optional(new property_lvar_port_direction()) )) ,
...
new property_actual_arg())) ) ;
    ...
    @Override
    public property_port_item create() {
        return new property_port_item();
    }
