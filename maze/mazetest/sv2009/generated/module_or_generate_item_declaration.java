...
public  class module_or_generate_item_declaration extends Acceptor implements NonTerminal, ITokenCodes {

    public module_or_generate_item_declaration() {
    }
...
new Terminal(SEMI))) ;
    ...
    @Override
    public module_or_generate_item_declaration create() {
        return new module_or_generate_item_declaration();
    }
